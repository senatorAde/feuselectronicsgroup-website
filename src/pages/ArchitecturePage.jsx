...
/**
 * /architecture — current-state architecture page (replaces /how-it-works).
  ...
  return (
    <div className="bg-navy-950 min-h-screen">
      <SEO
        ...
        description="The FEUS.ai governed request path as it exists today: typed intake, governed work orders, deny-by-default routing, pre-execution gates, and a fail-closed execution boundary. Execution is unavailable at this revision."
      />

      <section className="pt-24 pb-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <SectionLabel>Architecture · Current state</SectionLabel>
          <h1 className="section-heading text-4xl sm:text-5xl mt-4">
            How a governed request flows today
          </h1>
          <p className="mt-6 text-gray-300 leading-relaxed">
            This page shows the governed request path as it exists at the certified
            revision — including where it intentionally stops. FEUS.ai has a
            seven-stage governed execution design (stages 0–6); stages 0–5 are
            implemented and fail closed, and stage 6 execution is unavailable
            because no dispatcher or bound executor exists.
          </p>
        </div>
      </section>
      ...
      <section className="py-12 px-4 sm:px-6 lg:px-8 border-t border-white/[0.06]">
        <div className="max-w-4xl mx-auto">
          ...
          <div
            role="img"
            aria-label={
              'Current-state diagram of the FEUS.ai governed request path. ' +
              ...
              'Not implemented or mock: live ITSM connectors, sanitized outbound ticket updates, model invocation, live database execution, and rollback.'
            }
          ...
          >
            <div className="flex flex-wrap items-center gap-x-4 gap-y-1 text-xs text-gray-500 border-b border-white/[0.08] pb-4 mb-6">
              <span className="font-semibold text-amber-300/90 uppercase tracking-wide">Current state</span>
              <span>Diagram FEUS-ARCH-PUB-001 · v1.0</span>
              <span className="font-mono break-all">Revision {POSTURE.certifiedRevision}</span>
              <span>Environment: LOCAL / test evidence only</span>
            </div>
            ...
            <div className="mt-8 border-t border-dashed border-white/[0.15] pt-6">
              ...
              <ul className="grid sm:grid-cols-2 gap-2 text-sm text-gray-400">
                ...
                <li className="border border-dashed border-rose-500/40 rounded-lg px-3 py-2">Live database execution (no dispatcher/executor)</li>
          ...
          <div className="mt-10 grid gap-6">
            <div className="glass-card rounded-2xl p-6 text-sm text-gray-300 leading-relaxed">
              ...
              <p>
                When FEUS.ai materials mention a seven-stage governed execution design,
                they refer to gate stages 0–6. Stages 0–5 (pre-execution governance) are
                implemented and fail closed under their tested conditions. Stage 6
                (execution) is unavailable at this revision.
              </p>
            </div>
            <div className="glass-card rounded-2xl p-6 text-sm text-gray-300 leading-relaxed">
