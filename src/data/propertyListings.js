...
export const propertyListings = [
  {
    ...
    assets: [
      ...
      {
        id: 'cognac-leather-power-reclining-sofa-3-seater',
        title: 'Cognac Leather Power-Reclining Sofa (3-Seater)',
        category: 'Living Room',
        image: 'items/DSC_4646.JPG',
        description: 'Premium top-grain leather three-seater with three individual power-reclining seats, adjustable power headrests, channel-stitched backs, and outer arm cup holders. Heavy-duty steel mechanism; plugs into AC power.',
        condition: 'Excellent',
        availability: 'Available',
        price: '$1,250',
      },
      {
        id: 'cognac-leather-power-reclining-loveseat-console',
        title: 'Cognac Leather Power-Reclining Loveseat with Console',
        category: 'Living Room',
        image: 'items/DSC_4650.JPG',
        description: 'Matching two-seater loveseat with two power-reclining seats, adjustable power headrests, a fold-down center console with two cup holders and USB charging ports, plus outer arm cup holders. Pairs with the 3-seater sofa.',
        condition: 'Excellent',
        availability: 'Available',
        price: '$825',
      },
